...
import com.githubtrending.ImageCrop.view.HighlightView;
import com.githubtrending.MainApplication;
...
public class EditImage {
    ...
    public String saveToLocal(Bitmap bm) {
        ...
        String path = AbFileUtil.getImageDownloadDir(MainApplication.context) + File.separator + "dts" + System.currentTimeMillis() + ".jpg";
        AbFileUtil.writeBitmapToSD(path, bm, true);
